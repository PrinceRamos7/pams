...
class DashboardController extends Controller
{
    ...
    {
        // Attendance managers get a simplified dashboard
        if (auth()->user()->isAttendanceManager()) {
            // Get attendance-related statistics only
            ...
            return Inertia::render('Dashboard/Dashboard', [
                'stats' => [
                    'totalMembers' => 0, // Hidden for attendance managers
