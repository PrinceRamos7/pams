...
export default function MemberChartComponent({ 
    ...
    // Separate advisers and regular members
    const advisers = filteredMembers.filter(m => m.year === "Adviser" || m.status === "Adviser");
    const regularMembers = filteredMembers.filter(m => m.year !== "Adviser" && m.status !== "Adviser");

    // Group regular members by year in descending order
    const membersByYear = {
        "Fourth Year": regularMembers.filter(m => m.year === "Fourth Year"),
        "Third Year": regularMembers.filter(m => m.year === "Third Year"),
        "Second Year": regularMembers.filter(m => m.year === "Second Year"),
        "First Year": regularMembers.filter(m => m.year === "First Year"),
    };
                ...
                <div className="mb-12">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500">
                                {advisers.length} {advisers.length === 1 ? 'Adviser' : 'Advisers'}
                            </p>
                        </div>
                    ...
                    <div className="flex justify-center gap-8 flex-wrap">
                        {advisers.map((member, index) => (
                            <div key={member.member_id} className="flex-shrink-0">
                                <MemberCard
                                    member={member}
                                    index={index}
                                />
